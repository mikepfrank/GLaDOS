...
#|
#|		2. Define globals.
#|			2.1. Define global constants.
#|			2.2. Define global variables.
#|			2.3. Define global structures & objects.
#|
#|		3. Define classes.
#|			3.1. Define Message class.
#|			3.2. Define Conversation class.
#|
#|		4. Define update handler functions.
#|			4.1. Define user command handlers.
#|			4.2. Define multimedia handlers.
#|			4.3. Define normal message handlers.
#|			4.4. Define unknown command handler.
#|
#|		5. Main body -- bot startup.
#|			5.1. Display command list.
#|			5.2. Create Updater object.
#|			5.3. Configure dispatcher.
#|			5.4. Start main loop.
#|
#|
#|  Classes:
...
#|
#|
#|	Private (minor) functions:
#|  --------------------------
#|
#|		_blockUser() - Blocks a given user from accessing the bot.
#|
#|		_checkAccess() - Checks whether user may access the bot according to a given policy.
#|
...
#/=============================================================================|
#|	2. Define globals.							[python module code section]   |
#|																			   |
#|		The above is just general setup!  The real meat of the program		   |
#|		follows. In this section, we define important global variable		   |
#|		and constant values, and any associated minor functions.			   |
#|																		   	   |
...
#|vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv|
	...
	#/======================================================================
	#|	2.1. Define global constants.		[python module code subsection]
	#|
...
START_MESSAGE = aiConf.startMsg
	...
	#/======================================================================
	#|	2.2. Define global variables.		[python module code subsection]
	#|vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
...
_lastError = ""
	...
	#/~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	#|	2.3. Define global structures.		[python module code subsection]
	#|
...
#/==============================================================================
#|	3. Class definitions.							[python module code section]
#|
...
#|vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
	...
	#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	# 3.1. First, let's define a class for messages that remembers the
...
#__/ End of Message class definition.
	...
	#/~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	#|	3.2. The Conversation class is defined below.
	#|
...
class Conversation:
	...
	def add_message(self, message, finalize=True):
		...
		self.context_length = len(self.messages)	# Update the context_length counter.
		self.expand_context()	# Update the context string.
	...
	#__/ End conversation.get_chat_messages() instance method definition.
		...
		# Old versions of response prompt:
			...
			#'content': f"Assistant, your role in this chat is '{self.bot_name}'; " \
			#	"enter your next message below.",
			#	# This was my initial wording, but it seemed to cause some confusion.

			#'content': f"{self.bot_name}, please enter your response below at " \
			#	"the 'assistant' prompt:"
			#	# The above wording was agreed upon by me & Turbo (model 'gpt-3.5-turbo').

			# Trying this now:
			#'content': f"Please now generate {self.bot_name}'s response, in the " \
			#	"format:\n" \
			#	 r"%%%\n" \
...
#/==============================================================================
#|
#|	4. HANDLER FUNCTIONS.										  [code section]
#|	~~~~~~~~~~~~~~~~~~~~~
#|
...
#|vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
	...
	#/==========================================================================
	#| 4.1. Handler group 0 -- User command handlers.
	#|
	#|		Command		Handler Function	Description
	#|		~~~~~~~		~~~~~~~~~~~~~~~~	~~~~~~~~~~~
	#|		/start		handle_start()		Starts/resumes conversation.
...
def handle_start(update, context):
	...
	if not re.match(r"^[a-zA-Z0-9_-]{1,64}$", update.message.from_user.first_name):
	       ...
	       # Log the warning.
		_logger.warning(f"User {update.message.from_user.first_name} has an "
...
#__/
	...
	#/==========================================================================
	#| 4.2. Handler group 1 -- Multimedia input processing handlers.
	#|
	#|		For messages containing multimedia input, these handlers
	#|		generally do some preprocessing of the media, prior to
	#|		normal message handling. They are not intended to uniquely
...
#__/
	...
	#/==========================================================================
	#| 4.3. Handler group 2 -- Normal message handlers.
	#|
	#|		These handlers take care of normal message processing.
	#|
	#|			Handler Function	Description
