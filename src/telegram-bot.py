...
class Message:
	...
	def __init__(newMessage, sender:str, text:str):
...
class Conversation:
	...
	def __init__(self, chat_id:int):
		...
		self.read_archive()
			# Note this will retrieve at most the last self.context_length_max messages.
...
def handle_start(update, context):			# Context, in this context, is the Telegram context object. (Not the context string for passing to GPT-3.)
	...
	context.chat_data['conversation'] = conversation
		...
		# to add a __del__() method to the Conversation class, and it will
		# eventually get called when the no-longer-referenced Conversation object
