...
_ENGINES = [
	...
	{'model-family': 'Claude-3',	'engine-name': 'claude-3-sonnet-20240229',	'field-size': 32_768,	'prompt-price': 3e-3,		'price': 15e-3,		'is-chat':	True,	'has-vision': True,		'encoding': 'non-tiktoken'},
