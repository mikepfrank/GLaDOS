...
class _AnnounceFieldExistsAction: pass
class _AnnounceFieldExistsAction(_AiAnnouncementAction):
	
	"""Class for the cognitive system to announce that the receptive field exists."""

	def __init__(thisAction:_AnnounceFieldExistsAction,
		...
		_logger.debug("_AnnounceFieldExistsAction.__init__(): Initializing field-existence "
					  f"announcement action. Announcement text is: '{announcementText}'")

		super(_AnnounceFieldExistsAction, thisAction).__init__(
...
class TheCognitiveSystem:
	...
	def start(theCongitiveSystem:TheCognitiveSystem):
		...
		announcement = _AnnounceFieldExistsAction()
