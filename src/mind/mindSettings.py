...
class	TheMindSettings:
	...
	_DEFAULT_PERSONA_NAME		=	"Aria Instructo"
	_DEFAULT_PERSONA_ID			=	"Aria"			# Use this in input prompts.
	_DEFAULT_PERSONA_USERNAME	=	"aria_gpt35"	# Unix user account to run GLaDOS under.
	
			#|------------------------------------------------------------------
			#| Information about the underlying statistical NLP model we're using.
	
	_DEFAULT_MODEL_FAMILY		=	"GPT-3"						# This isn't really used yet.
	_DEFAULT_MODEL_VERSION		=	"gpt-3.5-turbo-instruct"	# Fast completion model, 4K tokens.
