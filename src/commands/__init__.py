#|==============================================================================
#|                  TOP OF FILE:    commands/__init__.py
#|------------------------------------------------------------------------------
#|   The below module documentation string will be displayed by pydoc3.
#|vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
"""
    FILE NAME:    commands/__init__.py    [Python package initialization module]

    FULL PATH:          $GIT_ROOT/GLaDOS/src/commands/__init__.py
    ...
    COMPONENT NAME:     GLaDOS.commands
    ...
    -----------------
        ...
        the 'commands' package within the GLaDOS software system.
    ...
    --------------------
        ...
        The purpose of the 'commands' package is to gather together
        the modules implementing the GLaDOS command interface, which
		is one of the major subsystems of GLaDOS.
		
		To clarify, the primary purpose of the command interface is
		to allow the A.I. itself to issue commands to the system from
		within the system.  To promote the A.I.'s autonomy, and its 
		sovereignty over its domicile (the 'D' in GLaDOS), note that 
		most of the commands are not intended for use by human users.  
		A permission system restricts which entities have authorization
		to issue which commands.
    

    PACKAGE DEPENDENCIES:
    ---------------------

        The commands package uses the _____ and ______ packages, and
    ...
    -----------------
        ...
        shown in the package's README.md file) is as follows:
			...
			[to fill in later]
                                                                             """
#|^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
#| End of module documentation string for commands/__init__.py.
#|------------------------------------------------------------------------------
    ...
    #|      this case) is the "commands/" subdirectory of the top-level
...
__all__ = [
	...
	'initializer',		# This module does the real work to initialize the command interface.
...
#|^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
#|                   END OF FILE:    commands/__init__.py
#|==============================================================================