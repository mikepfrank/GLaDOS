...
### 4. Communication system ([`comms/`](comms "comms/ directory"))

**[INCOMPLETE]** The GladOS Communication System (GCS) provides support for messaging between protocol-compatible entities in other user accounts on the current host, as well as other remote hosts on the Internet. It uses datagram sockets for local (intra-host) IPC, and the infrastructure/communicator module (which is TCP/IP based) for remote (inter-host) communication.

### 5. Configuration facility ([`config/`](config "config/ directory"))
...
### 6. System console ([`console/`](console "console/ directory"))
...
### 7. Display management facility ([`display/`](display "display/ directory"))
...
### 8. Entity system ([`entities/`](entities "entities/ directory"))
...
### 9. Event representations ([`events/`](events "events/ directory")) 
...
### 10. Receptive field facility ([`field/`](field "field/ directory"))
...
### 11. GPT-3 Interface ([`gpt3/`](gpt3 "gpt3/ directory"))
...
### 12. Help system ([`helpsys/`](helpsys "helpsys/ directory"))
...
### 13. History buffer ([`history/`](history "history/ directory"))
...
### 14. Infrastructure facility ([`infrastructure/`](infrastructure "infrastructure/ directory"))
...
### 15. Memory system ([`memory/`](memory "memory/ directory"))
...
### 16. Core cognitive system ([`mind/`](mind "mind/ directory"))
...
### 17. Process system ([`processes/`](processes "processes/ directory"))
...
### 18. Settings management system ([`settings/`](settings "settings/ directory"))
...
### 19. Supervisor system ([`supervisor/`](supervisor "supervisor/ directory"))
...
### 20. Terminal system ([`terminal/`](terminal "terminal/ directory"))
...
### 21. Test programs ([`test/`](test "test/ directory"))
...
### 22. Text tools ([`text/`](text "text/ directory"))
...
### 23. Tokenizer ([`tokenizer/`](tokenizer "tokenizer/ directory"))
...
### 25. Windowing system, text-based ([`windows/`](windows "windows/ directory"))
