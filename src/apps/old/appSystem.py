...
"""
	...
	-------------------
		...
		The general classes include:
			...
			* AppSystem		- Singleton class for the overall application
								system, itself.
...
global _APP_LIST		# We could put this into the AppSystem class instead.
    ...
    #|vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
		...
		#|		generally to the whole application system.
		#|
		#|vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
...
class AppSystem:
	...
	_appSystem = None	# Our singleton instance.

		# Special instance constructor for singleton classes.

	def __new__(thisClass, *args, **kwargs):
		if thisClass._appSystem is None:
			inst = super(AppSystem, thisClass).__new__(thisClass)
			thisClass._appSystem = inst
			inst._init(*args, **kwargs)		# Private one-time instance initializer.
		else:
			inst = thisClass._appSystem
		return inst

	def _init(self):	# One-time initializer for singleton instance.
...
class Unix_App(Application_):
    ...
    #|vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
			...
			#|------------------------------------------------------------------
			#|	Initialize the _APP_LIST global (declared earlier).
			#|
