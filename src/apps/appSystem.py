...
class Application_:
        """
                app.Application_                                                [module public abstract class]
                        ...
                        This is the abstract superclass from which the class for 
                        each specific GLaDOS application should be derived.
                        
                        The class for a typical specific application should be
                        declared as a singleton class to ensure 
                        ...
                        elements:
                                ...
                                - A data directory (within the AI's data directory).
                                        ...
                                        information between GLaDOS system runs.
