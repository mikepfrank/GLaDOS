...
from	display.display				import	TheDisplay, DisplayClient
	# The display facility, and the display client base class.
...
def _main():	
	...
	if doDebug:
		pass		# Maybe diplay the receptive field here for debug purposes?
